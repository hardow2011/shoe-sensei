...
class BrandTest < ActiveSupport::TestCase
  ...
  test "invalid without name" do
    brand = Brand.new(overview_en: 'A very hip brand!', overview_es: 'Una marca muy popular!', logo: @brooks_logo)
    brand.save
  ...
  test "invalid without logo" do
    brand = Brand.new(name: 'Adidas', overview_en: 'A very hip brand!', overview_es: 'Una marca muy popular!')
    brand.save
    refute brand.valid?, 'brand valid without name'
  ...
  test "invalid without English overview" do
    brand = Brand.new(name: 'Adidas', overview_es: 'Una marca muy popular!',logo: @brooks_logo)
    brand.save
  ...
  test "invalid without Spanish overview" do
    brand = Brand.new(name: 'Adidas', overview_en: 'A very hip brand!', logo: @brooks_logo)
    brand.save
  ...
  test "correct name parameterization to handle" do
    brand = Brand.new(name: 'This is an imaginary Company, Or what?', overview: 'A very hip brand!', logo: @brooks_logo)
    brand.save
    assert_equal brand.handle, 'this-is-an-imaginary-company-or-what', 'handle malformed'
  end

  test 'unique name' do
    brand = Brand.new(name: @brooks.name, overview: 'Does not matter', logo: @brooks_logo)
    brand.save
