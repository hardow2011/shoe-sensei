...
ActiveRecord::Schema[7.1].define(version: 2024_08_26_222211) do
  ...
  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id", deferrable: :deferred
